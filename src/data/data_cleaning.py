...
raw_member_df = raw_member_df[['member_id', 'is_trial_member', 'start_date', 'country_code', 'signup_flow', 'device', 'mediatype',
                               ...
                               'settlements', 'settlement_total', 'refunds', 'refund_total', 'chargebacks', 'chargeback_amount', 'fraud_120']]
